...
export class RoomSpriteCanvas implements IRoomRenderingCanvas
{
    ...
    public getDisplayAsTexture(): Texture
    {
        ...
        const texture = TextureUtils.createTexture(this._display.width, this._display.height);

        TextureUtils.writeToTexture(this._display, texture, true, new Matrix(1, 0, 0, 1, -(bounds.x), -(bounds.y)));
